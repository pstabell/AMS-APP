...
Generated at: 2026-04-05T05:19:41.221172+00:00
...
- Escalation: severity=critical owner=Traction destination=Render support unchanged_blocked_streak=8.
...
- Previous artifact generated at: 2026-04-05T05:19:16.723257+00:00
- Material change detected: NO
- Unchanged blocked streak: 8
...
- Blocked duration: 3d 0h 2m
- No-server duration: 2d 22h 1m
- Current state duration: 2d 22h 1m
...
- commission-tracker-app: host=commission-tracker-app.onrender.com; probe_path=/; status=200 OK; attachment_state=healthy-attached; x-render-origin-server=TornadoServer/6.5.5; x-render-routing=None; cf-ray=9e76196b2911586e-IAD; date=Sun, 05 Apr 2026 05:19:41 GMT
- commission-tracker-webhook: host=commission-tracker-webhook.onrender.com; probe_path=/health; status=404 Not Found; attachment_state=missing-backend-attachment; x-render-origin-server=None; x-render-routing=no-server; cf-ray=9e76196babfb05a7-IAD; date=Sun, 05 Apr 2026 05:19:41 GMT
...
## Artifact inventory
- latest_json: path=docs/smoke-checks/latest-trial-signup-smoke-check.json; exists=YES; size_bytes=41907; modified_at=2026-04-05T05:19:17.511523+00:00
- latest_markdown: path=docs/smoke-checks/latest-trial-signup-smoke-check.md; exists=YES; size_bytes=28261; modified_at=2026-04-05T05:19:17.511945+00:00
...
- smoke_check_script: path=scripts/trial_signup_smoke_check.py; exists=YES; size_bytes=95085; modified_at=2026-04-05T05:17:57.109317+00:00
- smoke_check_tests: path=test_trial_signup_smoke_check.py; exists=YES; size_bytes=85713; modified_at=2026-04-05T05:18:56.627810+00:00
- owner_ready_traction: path=docs/smoke-checks/owner-ready/traction.txt; exists=YES; size_bytes=651; modified_at=2026-04-05T05:19:17.512122+00:00
- owner_ready_render_support: path=docs/smoke-checks/owner-ready/render_support.txt; exists=YES; size_bytes=726; modified_at=2026-04-05T05:19:17.512218+00:00
- owner_ready_verification_shell: path=docs/smoke-checks/owner-ready/verification_shell.txt; exists=YES; size_bytes=584; modified_at=2026-04-05T05:19:17.512341+00:00
- owner_ready_archive: path=docs/smoke-checks/owner-ready/archive; exists=YES; size_bytes=None; modified_at=None
- recommended_attachments: docs/smoke-checks/latest-trial-signup-smoke-check.json, docs/smoke-checks/latest-trial-signup-smoke-check.md, docs/TRIAL_SIGNUP_E2E_REPORT_2026-04-01.md, render.yaml, docs/smoke-checks/owner-ready/traction.txt, docs/smoke-checks/owner-ready/render_support.txt
- render_support_packet_files: docs/smoke-checks/latest-trial-signup-smoke-check.json, docs/smoke-checks/latest-trial-signup-smoke-check.md, render.yaml, docs/smoke-checks/owner-ready/render_support.txt
- traction_handoff_files: docs/TRIAL_SIGNUP_E2E_REPORT_2026-04-01.md, docs/smoke-checks/latest-trial-signup-smoke-check.md, docs/smoke-checks/latest-trial-signup-smoke-check.json, docs/smoke-checks/owner-ready/traction.txt
...
- owner: Traction
- destination: Render support
- generated_at: 2026-04-05T05:19:41.221172+00:00
- incident_type: render-webhook-routing-outage
- unchanged_blocked_streak: 8
