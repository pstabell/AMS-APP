...
Generated at: 2026-04-05T07:18:24.282951+00:00
...
- Escalation: severity=critical owner=Traction destination=Render support unchanged_blocked_streak=11.
...
- Previous artifact generated at: 2026-04-05T07:18:00.475066+00:00
- Material change detected: NO
- Unchanged blocked streak: 11
...
- Blocked duration: 3d 2h 1m
- No-server duration: 3d 0h 0m
- Current state duration: 3d 0h 0m
...
- commission-tracker-app: host=commission-tracker-app.onrender.com; probe_path=/; status=200 OK; attachment_state=healthy-attached; x-render-origin-server=TornadoServer/6.5.5; x-render-routing=None; cf-ray=9e76c7525d1d8b8b-IAD; date=Sun, 05 Apr 2026 07:18:24 GMT
- commission-tracker-webhook: host=commission-tracker-webhook.onrender.com; probe_path=/health; status=404 Not Found; attachment_state=missing-backend-attachment; x-render-origin-server=None; x-render-routing=no-server; cf-ray=9e76c752ca1cc9a5-IAD; date=Sun, 05 Apr 2026 07:18:24 GMT
...
## Artifact inventory
- latest_json: path=docs/smoke-checks/latest-trial-signup-smoke-check.json; exists=YES; size_bytes=43885; modified_at=2026-04-05T07:18:25.116754+00:00
- latest_markdown: path=docs/smoke-checks/latest-trial-signup-smoke-check.md; exists=YES; size_bytes=29392; modified_at=2026-04-05T07:18:25.117267+00:00
- trial_signup_report: path=docs/TRIAL_SIGNUP_E2E_REPORT_2026-04-01.md; exists=YES; size_bytes=15451; modified_at=2026-04-05T05:19:35.560160+00:00
- render_blueprint: path=render.yaml; exists=YES; size_bytes=2080; modified_at=2026-04-03T01:15:05.095488+00:00
- smoke_check_script: path=scripts/trial_signup_smoke_check.py; exists=YES; size_bytes=98405; modified_at=2026-04-05T07:18:12.565779+00:00
- smoke_check_tests: path=test_trial_signup_smoke_check.py; exists=YES; size_bytes=88654; modified_at=2026-04-05T07:17:47.457536+00:00
- owner_ready_traction: path=docs/smoke-checks/owner-ready/traction.txt; exists=YES; size_bytes=651; modified_at=2026-04-05T07:18:25.117527+00:00
- owner_ready_render_support: path=docs/smoke-checks/owner-ready/render_support.txt; exists=YES; size_bytes=726; modified_at=2026-04-05T07:18:25.117694+00:00
- owner_ready_verification_shell: path=docs/smoke-checks/owner-ready/verification_shell.txt; exists=YES; size_bytes=584; modified_at=2026-04-05T07:18:25.117799+00:00
- escalation_packet_message: path=docs/smoke-checks/escalation-packet/render-support-message.txt; exists=YES; size_bytes=2406; modified_at=2026-04-05T07:18:25.118854+00:00
- escalation_packet_payload: path=docs/smoke-checks/escalation-packet/render-support-payload.json; exists=YES; size_bytes=1392; modified_at=2026-04-05T07:18:25.118966+00:00
- escalation_packet_manifest: path=docs/smoke-checks/escalation-packet/evidence-manifest.json; exists=YES; size_bytes=6486; modified_at=2026-04-05T07:18:25.119067+00:00
...
- recommended_attachments: docs/smoke-checks/latest-trial-signup-smoke-check.json, docs/smoke-checks/latest-trial-signup-smoke-check.md, docs/TRIAL_SIGNUP_E2E_REPORT_2026-04-01.md, render.yaml, docs/smoke-checks/owner-ready/traction.txt, docs/smoke-checks/owner-ready/render_support.txt, docs/smoke-checks/escalation-packet/render-support-message.txt, docs/smoke-checks/escalation-packet/render-support-payload.json, docs/smoke-checks/escalation-packet/evidence-manifest.json
- render_support_packet_files: docs/smoke-checks/latest-trial-signup-smoke-check.json, docs/smoke-checks/latest-trial-signup-smoke-check.md, render.yaml, docs/smoke-checks/owner-ready/render_support.txt, docs/smoke-checks/escalation-packet/render-support-message.txt, docs/smoke-checks/escalation-packet/render-support-payload.json, docs/smoke-checks/escalation-packet/evidence-manifest.json
...
- owner: Traction
- destination: Render support
- generated_at: 2026-04-05T07:18:24.282951+00:00
- incident_type: render-webhook-routing-outage
- unchanged_blocked_streak: 11
